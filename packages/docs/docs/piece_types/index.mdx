...
A Studio Guest Piece is used to automatically unmute and re-mute a guest's microphone via [Sisyfos](https://github.com/tv2/sisyfos-audio-controller).
...
A bare-bones graphic piece type only used as an example in the code.

## Stepped Graphic

A bare-bones graphic piece type extending the piece type above to demonstrate the stepped graphic features of Sofie UI.
