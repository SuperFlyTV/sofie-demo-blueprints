import { IBlueprintActionManifest, IShowStyleUserContext } from '@sofie-automation/blueprints-integration'
import { literal, t } from '../../common/util'
import { ActionId } from '../actionDefinitions'
import { getOutputLayerForSourceLayer, SourceLayer } from '../layers'

export function getGlobalActions(_context: IShowStyleUserContext): IBlueprintActionManifest[] {
	return [
