...
describe('Body parser', () => {
	test('test1', () => {
		...
		const result = ParseBody('00000000001', body1, cues1, fields)
	...
	test('test2', () => {
		...
		const result = ParseBody('00000000001', body2, cues2, fields)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
	...
	test('test3', () => {
		...
		const result = ParseBody('00000000001', body3, cues3, fields)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
					type: PartType.Kam,
	...
	test('test4', () => {
		...
		const cues4 = [['1']]
		const result = ParseBody('00000000001', body4, cues4, fields)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
					type: PartType.Unknown,
	...
	test('test5', () => {
		...
		const result = ParseBody('00000000001', body5, cues5, fields)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
					type: PartType.Kam,
	...
	test('test6', () => {
		...
		const cues6 = [['1']]
		const result = ParseBody('00000000001', body6, cues6, fields)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
					type: PartType.Kam,
	...
	test('test7', () => {
		...
		const cues7 = [['1'], ['2'], ['3'], ['4']]
		const result = ParseBody('00000000001', body7, cues7, fields)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
					type: PartType.Unknown,
	...
	test('test8', () => {
		...
		const result = ParseBody('00000000001', body8, cues8, fields)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
					type: PartType.Kam,
	...
	test('test9', () => {
		...
		const result = ParseBody('00000000001', body9, cues9, fields)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
					type: PartType.Kam,
	...
	test('test10', () => {
		...
		const result = ParseBody('00000000001', body10, cues10, fields)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
					type: PartType.Kam,
	...
	test('test11', () => {
		...
		const cues11 = [['1'], ['2'], ['3']]
		const result = ParseBody('00000000001', body11, cues11, fields)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
					type: PartType.Kam,
	...
	test('test12', () => {
		...
		const cues12 = [['1'], ['2'], ['3']]
		const result = ParseBody('00000000001', body12, cues12, fields)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
					type: PartType.Kam,
	...
	test('test13', () => {
		const body13 =
			'\r\n<p><a idref="0"></a></p>\r\n<p></p>\r\n<p></p>\r\n<p></p>\r\n<p></p>\r\n<p></p>\r\n<p></p>\r\n<p></p>\r\n<p></p>\r\n<p></p>\r\n<p></p>\r\n<p></p>\r\n<p></p>\r\n<p></p>\r\n<p></p>\r\n'
		const cues13 = [['1']]
		const result = ParseBody('00000000001', body13, cues13, fields)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
					type: PartType.Unknown,
