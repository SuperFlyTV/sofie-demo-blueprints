...
describe('Body parser', () => {
	...
	test('test7', () => {
		...
		const cues7 = [['1'], ['2'], ['3'], ['4']]
		const result = ParseBody('00000000001', body7, cues7)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
					type: PartType.Unknown,
	...
	test('test8', () => {
		...
		const result = ParseBody('00000000001', body8, cues8)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
					type: PartType.Kam,
	...
	test('test9', () => {
		...
		const result = ParseBody('00000000001', body9, cues9)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
					type: PartType.Kam,
	...
	test('test10', () => {
		...
		const result = ParseBody('00000000001', body10, cues10)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
					type: PartType.Kam,
	...
	test('test11', () => {
		...
		const cues11 = [['1'], ['2'], ['3']]
		const result = ParseBody('00000000001', body11, cues11)
		expect(result).toEqual(
			literal<PartDefinition[]>([
				{
					type: PartType.Kam,
