...
export default literal<BlueprintMappings>({
	...
	sisyfos_source_gst_1_st_a: literal<MappingSisyfos & BlueprintMapping>({
		device: DeviceType.SISYFOS,
		deviceId: 'sisyfos0',
		channel: 2,
		lookahead: LookaheadMode.NONE
	}),
	sisyfos_source_gst_2_st_a: literal<MappingSisyfos & BlueprintMapping>({
		device: DeviceType.SISYFOS,
		deviceId: 'sisyfos0',
		channel: 3,
		lookahead: LookaheadMode.NONE
	}),
	sisyfos_source_gst_3_st_a: literal<MappingSisyfos & BlueprintMapping>({
		device: DeviceType.SISYFOS,
		deviceId: 'sisyfos0',
		channel: 4,
		lookahead: LookaheadMode.NONE
	}),
	sisyfos_source_gst_4_st_a: literal<MappingSisyfos & BlueprintMapping>({
		device: DeviceType.SISYFOS,
		deviceId: 'sisyfos0',
		channel: 5,
		lookahead: LookaheadMode.NONE
	...
	sisyfos_source_gst_1_st_b: literal<MappingSisyfos & BlueprintMapping>({
		device: DeviceType.SISYFOS,
		deviceId: 'sisyfos0',
		channel: 8,
		lookahead: LookaheadMode.NONE
	}),
	sisyfos_source_gst_2_st_b: literal<MappingSisyfos & BlueprintMapping>({
		device: DeviceType.SISYFOS,
		deviceId: 'sisyfos0',
		channel: 9,
		lookahead: LookaheadMode.NONE
	}),
	sisyfos_source_gst_3_st_b: literal<MappingSisyfos & BlueprintMapping>({
		device: DeviceType.SISYFOS,
		deviceId: 'sisyfos0',
		channel: 10,
		lookahead: LookaheadMode.NONE
	}),
	sisyfos_source_gst_4_st_b: literal<MappingSisyfos & BlueprintMapping>({
		device: DeviceType.SISYFOS,
		deviceId: 'sisyfos0',
		channel: 11,
		lookahead: LookaheadMode.NONE
